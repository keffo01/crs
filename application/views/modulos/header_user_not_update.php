				...
				<li class="user-profile header-notification">
					<div class="dropdown-primary dropdown">
						<div class="dropdown-toggle" data-toggle="dropdown">
							...
							<span><?php echo $this->session->userdata('nombre_usuario')?></span>
							<i class="feather icon-chevron-down"></i>
						</div>
						<ul class="show-notification profile-notification dropdown-menu ">
							<li>
							<div class="css-tooltip-php bottom-php">
								<a href="javascript:void(0)">
									<i class="feather icon-settings rotate-refresh"></i> Actualizar datos
								</a>
								<span class="tt-content-php"><i></i> ⚠ Ya no puede actualizar sus datos cuando el estado de su solicitud esta "En proceso" o "Aceptado", cualquier cambio importante comunicarse directamente con la seccional a la que envió su solicitud.</span>
							</div>
							</li>
							<li>
		...
		<div class="card card_main p-fixed users-main">
			<div class="user-box">
				...
				<div class="main-friend-list">
					<div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip"
					...
					<div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe" data-toggle="tooltip"
					...
					<div class="media userlist-box" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip"
					...
					<div class="media userlist-box" data-id="4" data-status="online" data-username="Alia" data-toggle="tooltip"
					...
					<div class="media userlist-box" data-id="5" data-status="online" data-username="Suzen" data-toggle="tooltip"
